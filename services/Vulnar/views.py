...
from vulncraft.security import require_scanner_secret, validate_scan_target, sanitize_nmap_arguments
...
def scan_ports(request):
    ...
    try:
        ...
        try:
            arguments = sanitize_nmap_arguments(data.get("arguments", "-F"))
        except ValueError as e:
            return JsonResponse({"error": str(e)}, status=400)
