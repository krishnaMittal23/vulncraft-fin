...
exports.analyzeCode = async (req, res) => {
  ...
  try {
    ...
    const analysisReport = await analysisService.analyzeCode(code, language, req.userId);
...
exports.getQueryAboutCode = async (req, res) => {
  ...
  try {
    ...
    const analysisReport = await analysisService.getQueryAboutCode(code, question, req.userId);
